...
export const siteConfig = {
  ...
  content: {
    en: {
      ...
      nav: { about: "About", experience: "Experience", education: "Education", articles: "Articles", menu: "Menu", close: "Close menu" },
    ...
    pt: {
      ...
      nav: { about: "Sobre", experience: "Experiência", education: "Formação", articles: "Artigos", menu: "Menu", close: "Fechar menu" },
    ...
    es: {
      ...
      nav: { about: "Sobre", experience: "Experiencia", education: "Formación", articles: "Artículos", menu: "Menú", close: "Cerrar menú" },
